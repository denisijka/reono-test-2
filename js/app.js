(() => {
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".filter__btn ")) document.addEventListener("click", (function(e) {
                const overlay = document.querySelector(".overlay");
                if (bodyLockStatus && e.target.closest(".filter__btn ")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("page__filter__nav__action");
                    if (!e.target.closest(".filter__btn  ")) document.documentElement.classList.remove("page__filter__nav__action");
                    if (overlay) {
                        bodyLockToggle();
                        overlay.classList.toggle("open");
                    }
            ...
            if (document.querySelector(".open__icons_sort  ")) document.addEventListener("click", (function(e) {
                const overlay = document.querySelector(".overlay");
                if (bodyLockStatus && e.target.closest(".open__icons_sort  ")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("open__icons__form_action");
                    if (!e.target.closest(".open__icons_sort   ")) document.documentElement.classList.remove("open__icons__form_action");
                    if (overlay) {
                        bodyLockToggle();
                        overlay.classList.toggle("open");
                    }
            ...
            if (document.querySelector(".subscription__modal_btn")) document.addEventListener("click", (function(e) {
                const overlay = document.querySelector(".overlay");
                if (bodyLockStatus && e.target.closest(".subscription__modal_btn")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("form-book__button_modal_action");
                    if (!e.target.closest(".subscription__modal_btn")) document.documentElement.classList.remove("form-book__button_modal_action");
                    if (overlay) {
                        bodyLockToggle();
                        overlay.classList.toggle("open");
                    }
            ...
            if (document.querySelector(".offers__propose__btn")) document.addEventListener("click", (function(e) {
                const overlay = document.querySelector(".overlay");
                if (bodyLockStatus && e.target.closest(".offers__propose__btn")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("custoer__offers_proposition__active");
                    if (!e.target.closest(".offers__propose__btn")) document.documentElement.classList.remove("custoer__offers_proposition__active");
                    if (overlay) {
                        bodyLockToggle();
                        overlay.classList.toggle("open");
                    }
            ...
            if (document.querySelector(".btn_offers__more")) document.addEventListener("click", (function(e) {
                const overlay = document.querySelector(".overlay");
                if (bodyLockStatus && e.target.closest(".offers__more__mobile")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("mobail__customer__offers__active");
                    if (!e.target.closest(".offers__more__mobile")) document.documentElement.classList.remove("mobail__customer__offers__active");
                    if (overlay) {
                        bodyLockToggle();
                        overlay.classList.toggle("open");
                    }
            ...
            if (document.querySelector(".offers__propose_mob ")) document.addEventListener("click", (function(e) {
                const overlay = document.querySelector(".overlay");
                if (bodyLockStatus && e.target.closest(".offers__propose_mob")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("offers__propose_mob__active");
                    if (!e.target.closest(".offers__propose_mob ")) document.documentElement.classList.remove("offers__propose_mob__active");
                    if (overlay) {
                        bodyLockToggle();
                        overlay.classList.toggle("open");
                    }
        ...
        function menuClose() {
            ...
            document.documentElement.classList.add("page__filter__nav_action");
            document.documentElement.classList.add("open__icons__form_action");
            document.documentElement.classList.add("form-book__button_modal_action");
            document.documentElement.classList.add("custoer__offers_proposition__active");
            document.documentElement.classList.add("mobail__customer__offers__active");
            document.documentElement.classList.add("offers__propose_mob__active");
        }
        function showMore() {
        ...
        da.init();
        const btn_texno = document.querySelector(".specification__technical__btn");
        const btn_complect = document.querySelector(".specification__complect__btn");
        const contentTex = document.querySelector(".specification__technical__conteiner");
        const contentComp = document.querySelector(".specification__complect__conteiner");
        btn_texno?.addEventListener("click", (function(e) {
            contentTex.classList.add("show__content");
            contentComp.classList.remove("show__content");
            btn_texno.classList.add("active__link");
            btn_complect.classList.remove("active__link");
        }));
        btn_complect?.addEventListener("click", (function(e) {
            contentComp.classList.add("show__content");
            contentTex.classList.remove("show__content");
            btn_complect.classList.add("active__link");
            btn_texno.classList.remove("active__link");
        }));
        const btn_open_more = document.querySelector(".offers__more__dec");
        const more_page = document.querySelector(".customer__offers__more");
        btn_open_more?.addEventListener("click", (function() {
            more_page.classList.toggle("show_page");
        }));
        const btn_chenge = document.querySelector(".chendge__auto__dec");
        const modal_off = document.querySelector(".chendge__auto__collection");
        const open_modal = document.querySelector(".open  ");
        btn_chenge?.addEventListener("click", (function() {
            modal_off.classList.toggle("chendge__auto__active");
            open_modal.classList.add("overlay");
        }));
        const close__modal_auto = document.querySelector(".close__modal_auto");
        close__modal_auto?.addEventListener("click", (() => {
            modal_off.classList.remove("chendge__auto__active");
        }));
        const btn_more_propos = document.querySelector(".chendge__auto__mob");
        const wrapper = document.querySelector(".wrapper");
        btn_more_propos?.addEventListener("click", (() => {
            wrapper.classList.toggle("modal_active");
        }));
        const open_window_offers = document.querySelector(".offers__propose_dec");
        const window_offer = document.querySelector(".custoer__offers_proposition");
        open_window_offers?.addEventListener("click", (function() {
            window_offer.classList.toggle("custoer__offers_proposition__active");
        }));
        const clear = document.querySelector(".cansel__btn");
        clear?.addEventListener("click", (function() {
            window_offer.style.display = "none";
            open_window_offers.classList.toggle("offers__propose__active");
        }));
        window.onload = function() {
            ...
            var swiper = new Swiper(".mySwiperVehicle", {
                slidesPerView: 10,
                spaceBetween: 23,
                speed: 300,
                breakpoints: {
            ...
            swiper = new Swiper(".mySwiperTabs", {
                slidesPerView: 5,
                navigation: {
            ...
            swiper = new Swiper(".mySwiperThree", {
                slidesPerView: 4,
                spaceBetween: 45,
                pagination: {
            ...
            swiper = new Swiper(".mySwiperNavMenu", {
                slidesPerView: 7,
                spaceBetween: 0,
                speed: 300,
                breakpoints: {
            ...
            let nav_filter = document.querySelector(".search_result_by");
            let scrollpos = window.scrollY;
            const scrollChange = 10;
            const add_class_on_scroll = () => nav_filter?.classList.add("sticky");
            const rem_class_on_scroll = () => nav_filter?.classList.remove("sticky");
            window?.addEventListener("scroll", (function() {
                scrollpos = window.scrollY;
                if (scrollpos >= scrollChange) add_class_on_scroll(); else rem_class_on_scroll();
            }));
            const btn_modal_tg = document.querySelector(".currency__telegram");
            const modal_tg = document.querySelector(".subscription__modal__window");
            const btn_modal_em = document.querySelector(".currency__email");
            btn_modal_tg?.addEventListener("click", (() => {
                modal_tg.classList.add("subscription__form__tg");
            }));
            btn_modal_em?.addEventListener("click", (() => {
                modal_tg.classList.remove("subscription__form__tg");
            }));
            const scrollBlock = document.querySelector(".subscription__modal_btn");
            var scroll = 100;
            window.onscroll = onScroll;
            function onScroll() {
                var top = window.pageYOffset;
                if (scroll > top) scrollBlock?.classList.add("subscription__modal_btn_active"); else if (scroll < top) scrollBlock?.classList.remove("subscription__modal_btn_active");
                scroll = top;
            }
        };
        window["FLS"] = true;
